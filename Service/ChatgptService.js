...
Create "Your 5 Step Blueprint with EVIDENT", a structured guide with 5 bullet points in justified alignment to walk clients through the tokenization of the ${prompt}. The steps are:
...
Next, provide 3 examples that illustrate the potential of this tokenization in justified alignment, appealing to high-net-worth individuals and institutional investors. These examples should be concise and engaging.
Conclude with a section "What you can do with the tokenized ${prompt}?", comprising three categories and answer it in bullet points: Unprecedented Liquidity, Unique Diversification, and Broad Appeal. Each category should be explained in a clear, concise sentence.
The response should be an HTML code, with properly spaced and left-aligned bullet points, and devoid of jargon, buzzwords, cliches, complex metaphors, unnecessary adjectives, or humor. The aim is to pique interest in tokenization with EVIDENT and encourage clients to book a demo. Don't add extra quotation marks and only use numbered list. Make internal sections justified alignment and ensure font-size is consistent and there should not be a starting and ending with quotation marks`;
